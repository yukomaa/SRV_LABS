...
void cook(int& efficiency) {        //функция работы повара
...
void eat(int& dish, int& eaten, int& gluttony) { //функция работы толстяков
    while (true) {
...
void situation(int gluttony, int efficiency) { //проигрывание ситуаций
    dish1 = 3000;
    dish2 = 3000;
    dish3 = 3000;
